...
export default function LGDWorkspaceSidebar() {
  ...
  return (
    <>
      ...
      <aside className="fixed left-4 top-4 z-[2147483646] hidden h-[calc(100vh-32px)] w-[400px] flex-col overflow-y-auto overflow-x-hidden rounded-[30px] lgd-sidebar-scroll border border-yellow-600/20 bg-[#070707]/95 p-4 shadow-[0_0_55px_rgba(255,184,0,0.08)] backdrop-blur-xl lg:flex">
