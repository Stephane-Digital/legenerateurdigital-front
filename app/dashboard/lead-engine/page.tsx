...
export default function LeadEnginePage() {
  ...
  async function copySioReady(payload: LeadEnginePayload) {
    ...
    try {
      ...
      flash("⚠️ Copie impossible automatiquement.");
    }
          ...
          <CardLuxe className="block w-full min-w-0 h-full px-6 py-6">
            <div className="flex h-full flex-col">
              ...
              <div className="mt-6 flex flex-1 flex-col gap-5">
                <div className="rounded-[26px] border border-yellow-600/20 bg-[#0b0b0b] p-4">
                  ...
                  <div className="mt-4 overflow-hidden rounded-[24px] border border-yellow-600/15 bg-[#111]">
                    ...
                    <div className="grid gap-4 px-5 py-5">
                      ...
                      <div className="rounded-2xl border border-yellow-600/15 bg-[#0b0b0b] p-4">
                        <div className="text-sm font-semibold text-yellow-200">Bloc formulaire</div>
                        <p className="mt-2 text-sm text-white/70">{preview.landing.formIntro}</p>
                        <div className="mt-4 grid gap-3 sm:grid-cols-[1fr_auto]">
                          <div className="rounded-2xl border border-yellow-600/15 bg-[#111] px-4 py-3 text-sm text-white/40">
                            email@exemple.com
                          </div>
                          <button
                            type="button"
                            className="rounded-2xl bg-gradient-to-r from-[#ffb800] to-[#ffcc4d] px-4 py-3 text-sm font-semibold text-black"
                          >
                            {preview.landing.formButton}
                          </button>
                        </div>
                      </div>
                ...
                <div className="rounded-[26px] border border-yellow-500/20 bg-yellow-500/10 p-4">
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      <p className="text-yellow-100 font-semibold">Audit IA conversion</p>
                      <p className="mt-1 text-sm text-white/70">
                        Évaluation automatique de la cohérence du funnel.
                      </p>
                    </div>
                    <div className="text-right">
                      <p className="text-3xl font-extrabold text-white">{conversionAudit.score}</p>
                      <p className="text-xs uppercase tracking-[0.14em] text-white/45">score</p>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 grid gap-2 text-sm text-white/80">
                    {conversionAudit.suggestions.map((suggestion, index) => (
                      <p key={`audit-suggestion-${index}`}>• {suggestion}</p>
                    ))}
                  </div>
                </div>
