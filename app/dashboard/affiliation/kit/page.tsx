...
export default function AffiliationKitPage() {
  return (
    <div className="min-h-screen flex flex-col items-center text-center px-6 pt-[120px] bg-[#0a0a0a] text-white">
      ...
      >
        <CardLuxe className="w-full px-6 pt-7 pb-8 text-center">
          ...
          <div className="flex flex-col gap-6">
            <div>
              <h2 className="text-xl font-semibold text-[#ffb800] mb-2">
                Ton lien affilié officiel
              </h2>
              <p className="text-sm text-gray-300 leading-relaxed">
                Utilise ce lien dans tous tes emails, posts, DMs, stories, messages WhatsApp,
                publications LinkedIn et ressources externes.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
          <CardLuxe className="w-full px-6 pt-6 pb-7 text-left">
            <h2 className="text-xl font-semibold text-[#ffb800] mb-2">Scripts rapides</h2>
            <p className="text-sm text-gray-300 mb-5">
              DM Instagram, Messenger, WhatsApp, LinkedIn et relance douce prêts à copier.
            </p>
          ...
          <CardLuxe className="w-full px-6 pt-6 pb-7 text-left">
            <h2 className="text-xl font-semibold text-[#ffb800] mb-2">Emails prêts à envoyer</h2>
            <p className="text-sm text-gray-300 mb-5">
              Emails de découverte, objection, bénéfices et relance pour recommander LGD.
            </p>
            <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
          <CardLuxe className="w-full px-6 pt-6 pb-7 text-left">
            <h2 className="text-xl font-semibold text-[#ffb800] mb-2">Posts réseaux sociaux</h2>
            <p className="text-sm text-gray-300 mb-5">
              Publications prêtes pour Instagram, Facebook et LinkedIn.
            </p>
            <div className="space-y-4">
          ...
          <CardLuxe className="w-full px-6 pt-6 pb-7 text-left">
            <h2 className="text-xl font-semibold text-[#ffb800] mb-2">Hooks, CTA & angles</h2>
            <p className="text-sm text-gray-300 mb-5">
              Des accroches courtes, des appels à l’action et des promesses à réutiliser partout.
            </p>
            <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
          <CardLuxe className="w-full px-6 pt-6 pb-7 text-left">
            <h2 className="text-xl font-semibold text-[#ffb800] mb-2">Assets premium</h2>
            <p className="text-sm text-gray-300 mb-5">
              Zone visuels officiels : stories, posts, carrousels, covers Reels et bannières.
            </p>
          ...
          <CardLuxe className="w-full px-6 pt-6 pb-7 text-left">
            <h2 className="text-xl font-semibold text-[#ffb800] mb-2">Scripts Reels / Stories</h2>
            <p className="text-sm text-gray-300 mb-5">
              Scripts courts pour vidéo face cam, démonstration écran ou story rapide.
            </p>
            <div className="space-y-4">
        ...
        <CardLuxe className="w-full px-6 pt-6 pb-7 text-left">
          <h2 className="text-xl font-semibold text-[#ffb800] mb-4">Tunnel recommandé</h2>
