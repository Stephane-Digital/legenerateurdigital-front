...
export default function PostEditor({
  ...
  return (
    <div className="w-full flex justify-center pt-[110px] pb-20 max-[639px]:block max-[639px]:pt-0 max-[639px]:pb-24">
      {/* ================= CANVAS XL WRAPPER ================= */}
      <div className="w-full max-w-[1600px] px-6 max-[639px]:max-w-none max-[639px]:px-0">
        <div className="rounded-3xl border border-yellow-500/25 bg-[#262626] p-8 max-[639px]:rounded-none max-[639px]:border-0 max-[639px]:bg-transparent max-[639px]:p-0">
          ...
          {/* ================= IA COPILOT (POST 1:1) ================= */}
          <div
            className="mb-6 rounded-3xl p-5 max-[639px]:rounded-none max-[639px]:border-x-0 max-[639px]:p-3"
            style={{
