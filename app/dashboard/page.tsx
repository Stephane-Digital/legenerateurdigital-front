      ...
      <div className="sticky top-0 z-[2147483646] border-b border-yellow-600/15 bg-[#050505]/92 px-4 py-3 backdrop-blur-xl lg:hidden">
        ...
        {mobileMenuOpen ? (
          <div className="mt-4 grid gap-2 rounded-3xl border border-yellow-600/20 bg-[#080808] p-3 text-sm shadow-[0_0_45px_rgba(255,184,0,0.12)]">
            ...
            <button type="button" onClick={() => ('/dashboard/automatisations/reseaux_sociaux/planner')} className="rounded-2xl px-4 py-3 text-left text-white/75 hover:bg-yellow-500/10">📅 Planner IA</button>
            <button type="button" onClick={() => ('/dashboard/library')} className="rounded-2xl px-4 py-3 text-left text-white/75 hover:bg-yellow-500/10">📚 Bibliothèque</button>
