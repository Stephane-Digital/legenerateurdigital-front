...
export default function PlannerPage() {
  ...
  return (
    <div className="min-h-screen px-6 pt-[70px] pb-10 text-white bg-[#0a0a0a] flex flex-col items-center">
      ...
      >
        <FaLightbulb className="text-6xl mx-auto text-[#ffb800] mb-4 drop-shadow-[0_0_15px_rgba(255,184,0,0.35)]" />
        <h1 className="text-4xl font-bold text-[#ffb800] mb-3">Content Planner IA</h1>
        <p className="text-gray-300 text-lg">
          Brainstorming intelligent, idées illimitées et suggestions quotidiennes.
        </p>
      </motion.div>
      ...
      >
        <FaLightbulb className="text-3xl mx-auto text-[#ffb800] mb-4" />
        <p className="text-gray-400 text-sm mb-5">Le moteur d'idées IA arrive bientôt.</p>
