...
import { ArrowLeft, Mail, Stars } from "lucide-react";
...
function EmailCampaignPageInner() {
  ...
  // ✅ FIX TS minimal : le composant n’expose pas label/placeholder dans ses Props actuelles
    ...
    <div className="min-h-screen pt-[40px] px-6 bg-[#0a0a0a] text-white">
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-yellow-400 mt-4 flex items-center gap-3">
          Campagne Email <Mail size={26} className="text-yellow-300" />
        </h1>

        <p className="text-gray-300 mt-2">
          Configure ton email et génère du contenu automatiquement via l’IA.
        </p>
      </motion.div>
      ...
      >
        ...
        <CampaignAIGeneratorAny
          label="Brief IA"
          placeholder="Explique le type d’email que tu veux (accroche, pitch, storytelling, appel à l’action…)."
