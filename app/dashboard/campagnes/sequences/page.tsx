...
import { ArrowLeft, Layers, Stars } from "lucide-react";
...
function SequenceCampaignPageInner() {
    ...
    <div className="min-h-screen pt-[40px] px-6 bg-[#0a0a0a] text-white">
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-yellow-400 mt-4 mb-3 flex items-center gap-3">
          ...
          <Layers size={26} className="text-yellow-300" />
        </h1>

        <p className="text-gray-300">
          Générez automatiquement des séquences complètes d’emails (Email 1 → Email 2 → ...).
        </p>
      </motion.div>
      ...
      >
        ...
        <CampaignAIGeneratorAny
          label="Brief IA"
          placeholder="Explique le type de séquence que tu veux (3 emails, structure AIDA, persuasion, storytelling…)."
